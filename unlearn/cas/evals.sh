...
#SBATCH --job-name=a_evals_e2eu                  				                    	# Job name
#SBATCH --output=/home/a5m/scasper.a5m/owsg/outfiles/a_evals_e2eu_%A_%a.out            	 # Standard output and error log
...
# eleuther
python evals.py --model_name=${model} --revision=${revision} --evals mmlu mmlu_no_bio hellaswag piqa lambada wmdp_bio_aisi wmdp_bio_aisi_cloze_verified
