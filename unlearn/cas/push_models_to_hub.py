...
if __name__ == "__main__":
    ...
    for model_name, save_name in zip(models, save_names):
        ...
        if 'rmu' in model_name or '5percent' in model_name or 'lie_o' in model_name or 'smollm' in model_name or 'deepfried' in model_name or 'deep_fry' in model_name or 'replace' in model_name:
            revision = 'main'
        else:
